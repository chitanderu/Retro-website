    ...
    <footer className="border-t-2 border-dashed border-secondary/30 bg-base-200/50 py-6">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-3 px-4">
        ...
        <div className="flex gap-2">
          <div className="flex h-[31px] w-[88px] items-center justify-center rounded border border-dashed border-neutral/30 bg-base-300/50 font-[family-name:var(--font-pixel-mplus)] text-[7px] text-base-content/30">
            NEXT.JS
          </div>
          <div className="flex h-[31px] w-[88px] items-center justify-center rounded border border-dashed border-neutral/30 bg-base-300/50 font-[family-name:var(--font-pixel-mplus)] text-[7px] text-base-content/30">
            TAILWIND
        ...
        <p className="font-[family-name:var(--font-pixel-mplus)] text-xs text-base-content/30">
          &copy; 2025 ✧ made with ♡
        </p>
      </div>
    </footer>
